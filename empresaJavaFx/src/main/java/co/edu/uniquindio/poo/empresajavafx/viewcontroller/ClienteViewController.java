package co.edu.uniquindio.poo.empresajavafx.viewcontroller;

import co.edu.uniquindio.poo.empresajavafx.App;
import co.edu.uniquindio.poo.empresajavafx.controller.ClienteController;
...
public class ClienteViewController {
    ...
    ObservableList<Cliente> listClientes = FXCollections.observableArrayList(); //lista que aparece en la tabla
    Cliente selectedCliente; //al cliente sobre el que se le dé click
