...
public class Viaje {
    ...
    public Viaje(String id,Date fecha, String hora, int cantidadPasajeros, double tarifa) {
        this.id = id;
        this.fecha=fecha;
        this.hora=hora;
        this.cantidadPasajeros=cantidadPasajeros;
    ...
    public Viaje(String id, String fecha, String hora, int cantidadPasajeros, double tarifa) {
